...
export default function Index() {
  return (
    <div className="min-h-screen bg-health-white font-body">
      ...
      <header className="bg-health-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 lg:px-[187px]">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between py-4 lg:py-5 gap-4">
            {/* Contact Info */}
            <div className="flex flex-col sm:flex-row gap-4 lg:gap-6">
              {/* Emergency */}
              <div className="flex items-center gap-3">
                <div className="relative">
                  <Phone className="w-10 h-9 text-health-secondary" strokeWidth={2} />
                </div>
                <div>
                  <div className="text-health-secondary font-medium text-sm uppercase tracking-wide">
                    Emergency
                  </div>
                  <div className="text-health-primary font-medium">
                    (237) 681-812-255
                  </div>
                </div>
              </div>
              ...
              {/* Work Hours */}
              <div className="flex items-center gap-3">
                <Clock className="w-8 h-8 text-health-secondary" strokeWidth={2} />
                <div>
                  <div className="text-health-secondary font-medium text-sm uppercase tracking-wide">
                    Work Hour
                  </div>
              ...
              {/* Location */}
              <div className="flex items-center gap-3">
                <MapPin className="w-8 h-9 text-health-secondary" strokeWidth={2} />
                <div>
                  <div className="text-health-secondary font-medium text-sm uppercase tracking-wide">
                    Location
                  </div>
            ...
            {/* Logo */}
            <div className="text-3xl lg:text-4xl font-heading font-normal uppercase">
              <span className="text-health-secondary">Healt</span>
      ...
      {/* Navigation */}
      <nav className="bg-health-secondary">
        <div className="max-w-7xl mx-auto px-4 lg:px-[187px]">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between py-4 lg:py-5 gap-4">
            {/* Navigation Links */}
            <div className="flex flex-wrap items-center gap-5">
              <a href="#" className="text-health-white text-lg hover:text-health-accent transition-colors">Home</a>
              <a href="#" className="text-health-white text-lg hover:text-health-accent transition-colors">About us</a>
              <a href="#" className="text-health-accent text-lg font-semibold">Services</a>
              <a href="#" className="text-health-white text-lg hover:text-health-accent transition-colors">Doctors</a>
              <a href="#" className="text-health-white text-lg hover:text-health-accent transition-colors">News</a>
              <a href="#" className="text-health-white text-lg hover:text-health-accent transition-colors">Contact</a>
            </div>

            {/* Search and Appointment Button */}
            <div className="flex items-center gap-4">
              <Search className="w-6 h-6 text-health-white" />
              <button className="bg-health-accent text-health-primary px-6 py-3 rounded-full font-medium hover:bg-opacity-90 transition-colors flex items-center gap-2">
                Appointment
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <a href="#" className="block text-health-white hover:text-health-accent transition-colors">Doctors</a>
