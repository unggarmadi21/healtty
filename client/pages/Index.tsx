            ...
            <div className="bg-white border border-medical-primary/20 rounded-lg p-6 h-full">
              <div className="space-y-8">
                <div className="text-center p-6 border-b border-medical-primary/10">
                  ...
                  <h3 className="text-medical-black font-medium">
                    Free Checkup
                  </h3>
                </div>
                ...
                <div className="text-center p-6 bg-medical-secondary text-white rounded-lg">
                  ...
                  <h3 className="text-medical-accent font-medium">
                    Cardiogram
                  </h3>
                </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              >
                ...
                >
                  <svg
                    className={`w-6 h-6 ${specialty.highlighted ? "text-medical-secondary" : "text-white"}`}
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            ...
            <div className="bg-medical-accent rounded-lg p-8">
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div className="bg-medical-secondary text-white p-4 rounded-tr-lg relative">
                  ...
                  <svg
                    className="w-4 h-4 text-medical-accent absolute right-4 top-1/2 transform -translate-y-1/2"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-medical-secondary text-white p-6 rounded-lg flex items-center gap-4">
              <svg
                className="w-12 h-12 text-medical-accent"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
