...
export default function Contact() {
  ...
  return (
    <Layout>
      ...
      <section className="w-full px-4 md:px-8 lg:px-[187px] py-8 md:py-16">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            {/* Email */}
            <div className="bg-health-accent rounded-md p-6 md:p-8">
            ...
            {/* Working Hours */}
            <div className="bg-medical-white rounded-md p-6 md:p-8">
      ...
      {/* News Section */}
      <section className="w-full bg-health-accent py-12 md:py-16">
