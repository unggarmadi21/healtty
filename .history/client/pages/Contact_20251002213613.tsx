        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2">
            <div className="mb-6 md:mb-8">
              <p className="text-p text-base md:text-lg font-bold uppercase tracking-widest mb-2">Get in touch</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-0">
              <div className="flex flex-col md:flex-row gap-0">
                <input
                  ...
                  className="flex-1 bg-secondary text-white placeholder:text-white px-5 py-3 md:py-4 md:rounded-tl-md focus:outline-none"
                />
                <input
                  type="email"
                  placeholder="Email"
                  ...
                  className="flex-1 bg-secondary text-white placeholder:text-white px-5 py-3 md:py-4 md:rounded-tr-md focus:outline-none"
                />
              </div>
              <input
                type="text"
                ...
                className="w-full bg-secondary text-white placeholder:text-white px-5 py-3 md:py-4 focus:outline-none"
              />
              <textarea
                placeholder="Message"
                ...
                rows={6}
                className="w-full bg-secondary text-white placeholder:text-white px-5 py-3 md:py-4 focus:outline-none resize-none"
              />
              <button
                type="submit"
                className="w-full bg-accent text-secondary px-5 py-3 md:py-4 rounded-b-md font-medium uppercase hover:bg-accent/90 transition-colors"
              >
                Submit
              </button>
            </form>
