        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-[187px]">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between py-4 lg:py-5 gap-4">
            ...
            <div className="flex flex-wrap items-center gap-5">
              ...
              <a href="#" className="text-health-white text-lg hover:text-health-accent transition-colors">Services</a>
              <a href="/doctors" className="text-health-accent text-lg font-semibold">Doctors</a>
