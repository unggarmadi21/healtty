            ...
            <div>
              ...
              <div className="flex">
                ...
                />
                 <button
    type="submit"
    className="bg-medical-accent px-4 py-3 rounded-r-lg flex items-center gap-2 hover:bg-medical-primary transition-colors"
    aria-label="Send email"
  >
    <span className="text-medical-primary font-semibold">Send</span>
    <svg
