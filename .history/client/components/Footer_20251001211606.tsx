            ...
            <div>
              ...
              <div className="flex">
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-l-lg text-health-primary bg-health-accent placeholder-health-primary/70"
                />
                <button className="bg-health-accent px-4 py-3 rounded-r-lg hover:bg-primary transition-colors" type="submit">
                <svg
